...
Original file is located at
    https://colab.research.google.com/drive/1rCTjwGAu36mmGn4LbI4q7lbHEGM2Im4W
...
cur.execute(
    """
    SELECT info ->> 'nationality' AS nat, COUNT(*)
    FROM moma_artists
...
axes.bar(xpos, dataframe["count"], width=0.50)
axes.set_xticks(xpos)
axes.set_xticklabels(dataframe["nat"])
axes.set_ylabel("Count", fontsize=12)
...
title = "Aggregated Tally of Artworks Obtained"
query = """
